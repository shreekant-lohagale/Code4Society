...
export const predictLifestyle = async (formData) => {
    ...
    try {
        ...
        console.error("Lifestyle Prediction Failed:", error);
        // Fallback to minimal mock if API fails
        return { lifestyle_carbon: 1250, error: true };
    }
};
...
export const predictImage = async (imageFile) => {
    ...
    try {
        ...
        // We need to map these to include weight and carbon for the UI
        ...
        console.error("Vision Prediction Failed:", error);
        return [];
    }
};
...
export const predictSensorData = async () => {
    ...
    // Fallback Mock
    return {
        current_cumulative_kg: 5.4,
        predicted_midnight_kg: 12.8,
        raw_adc_history: [120, 145, 110, 160, 130, 140, 155, 125, 135, 150, 145, 130, 120, 115, 140]
    };
};
